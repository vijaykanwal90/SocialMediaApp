...
const PostWidget = ({
    ...
    const patchLike = async () => {
        ...
        const response = await fetch(`https://social-media-app-one-lyart.vercel.app/posts/${postId}/like`, {
            method: "PATCH",
            headers: {
            ...
            {picturePath &&
                (
                    <img width="100%"
                        ...
                        src={`https://social-media-app-one-lyart.vercel.app/assets/${picturePath}`}
                    />
                )}
